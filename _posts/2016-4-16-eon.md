...
The data transformation style of programming emphasized by this naming style seems to fit well with Clojure, and the type-like names do seem to facilitate function reuse.
